...
public class FallbackErrorHandler implements ErrorHandler {
	private final AndroidErrorHandler androidErrorHandler;
	private Screen screen;

	public FallbackErrorHandler(AndroidErrorHandler androidErrorHandler) {
	...
	public void error(Throwable throwable) {
		if (null==screen) {
			androidErrorHandler.error(throwable);
		}
		else {
			screen.error(throwable);
		}
	}
