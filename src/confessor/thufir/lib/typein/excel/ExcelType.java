...
*/
package confessor.thufir.lib.typein.excel;
...
public class ExcelType extends ListType {
	private static final String TYPE="excel";
	
	public ExcelType() {
		super(new TrimNewlineLineBytes(), "Excel", TYPE,
				new ResourceProgram("Excel.bas", TYPE));
	}
}
