...
import confessor.thufir.lib.color.BrightnessClassifierInitializerFactory;
import confessor.thufir.lib.image.Filter;
import confessor.thufir.lib.image.Image;

public interface ImageStream
		extends BrightnessClassifierInitializerFactory, ErrorHandler {
	Filter filter() throws Throwable;
	void next(BrightnessClassifier brightnessClassifier, Image image)
			throws Throwable;
}
